 ...
 *  @generated
 */
library nebula_meta.src.get_edge_index_req;
...
class GetEdgeIndexReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetEdgeIndexReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetEdgeIndexReq(");
