 ...
 *  @generated
 */
library nebula_meta.src.list_index_status_resp;
...
class ListIndexStatusResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListIndexStatusResp");
  ...
  static final TField _STATUSES_FIELD_DESC =
      new TField("statuses", TType.LIST, 3);

  int? _code;
  static const int CODE = 1;
  t_nebula.HostAddr? _leader;
  static const int LEADER = 2;
  List<IndexStatus>? _statuses;
  ...
  // statuses
  List<IndexStatus>? get statuses => this._statuses;

  set statuses(List<IndexStatus>? statuses) {
    ...
    switch (fieldID) {
      ...
      case STATUSES:
        if (value == null) {
          ...
          this.statuses = value as List<IndexStatus>?;
        }
        break;
  ...
  write(TProtocol oprot) {
    ...
    if (this.statuses != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.statuses?.length));
        for (var elem227 in this.statuses ?? []) {
          elem227.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListIndexStatusResp(");
