 ...
 *  @generated
 */
library nebula_storage.src.add_task_resp;
...
class AddTaskResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("AddTaskResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("AddTaskResp(");
