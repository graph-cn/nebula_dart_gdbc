 ...
 *  @generated
 */
library nebula_storage.src.delete_tags_request;
...
class DeleteTagsRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DeleteTagsRequest");
  ...
  // parts
  Map<int, List<DelTags>>? get parts => this._parts;

  set parts(Map<int, List<DelTags>>? parts) {
    this._parts = parts;
  }
    ...
    switch (fieldID) {
      ...
      case PARTS:
        if (value == null) {
          ...
          this.parts = value as Map<int, List<DelTags>>;
        }
        break;
      ...
      switch (field.id) {
        ...
        case PARTS:
          if (field.type == TType.MAP) {
            {
              TMap _map166 = iprot.readMapBegin();
              this.parts = new Map<int, List<DelTags>>();
              for (int _i167 = 0; _i167 < _map166.length; ++_i167) {
                int _key168;
                List<DelTags> _val169;
                _key168 = iprot.readI32();
                {
                  ...
                  for (int _i171 = 0; _i171 < _list170.length; ++_i171) {
                    DelTags _elem172;
                    _elem172 = new DelTags();
                    _elem172.read(iprot);
                    _val169.add(_elem172);
                  }
                  iprot.readListEnd();
                }
                this.parts?[_key168] = _val169;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parts != null) {
      oprot.writeFieldBegin(_PARTS_FIELD_DESC);
      {
        ...
        for (var elem174 in this.parts?.keys ?? <int>[]) {
          oprot.writeI32(elem174);
          {
            oprot.writeListBegin(
                new TList(TType.STRUCT, this.parts?[elem174]?.length));
            for (var elem175 in this.parts?[elem174] ?? <DelTags>[]) {
              elem175.write(oprot);
            }
            oprot.writeListEnd();
          }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DeleteTagsRequest(");
