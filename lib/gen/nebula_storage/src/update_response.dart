 ...
 *  @generated
 */
library nebula_storage.src.update_response;
...
class UpdateResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("UpdateResponse");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("UpdateResponse(");
