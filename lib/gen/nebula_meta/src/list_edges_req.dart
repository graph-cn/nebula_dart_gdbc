 ...
 *  @generated
 */
library nebula_meta.src.list_edges_req;
...
class ListEdgesReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListEdgesReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListEdgesReq(");
