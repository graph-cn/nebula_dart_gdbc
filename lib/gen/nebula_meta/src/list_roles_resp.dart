 ...
 *  @generated
 */
library nebula_meta.src.list_roles_resp;
...
class ListRolesResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListRolesResp");
  ...
  static final TField _ROLES_FIELD_DESC = new TField("roles", TType.LIST, 3);
  ...
  // roles
  List<RoleItem>? get roles => this._roles;

  set roles(List<RoleItem>? roles) {
    this._roles = roles;
  }

  bool isSetRoles() => this.roles != null;
    ...
    switch (fieldID) {
      ...
      case ROLES:
        if (value == null) {
          ...
          this.roles = value as List<RoleItem>?;
        }
        break;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i201 = 0; _i201 < _list200.length; ++_i201) {
                RoleItem _elem202;
                _elem202 = new RoleItem();
                _elem202.read(iprot);
                this.roles?.add(_elem202);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.roles != null) {
      oprot.writeFieldBegin(_ROLES_FIELD_DESC);
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.roles?.length));
        for (var elem203 in this.roles ?? []) {
          elem203.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListRolesResp(");
