 ...
 *  @generated
 */
library nebula_meta.src.list_spaces_resp;
...
class ListSpacesResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListSpacesResp");
  ...
  static final TField _SPACES_FIELD_DESC = new TField("spaces", TType.LIST, 3);
    ...
    switch (fieldID) {
      ...
      case SPACES:
        if (value == null) {
          ...
          this.spaces = value as List<IdName>?;
        }
        break;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.spaces = <IdName>[];
              for (int _i85 = 0; _i85 < _list84.length; ++_i85) {
                IdName _elem86;
                _elem86 = new IdName();
                _elem86.read(iprot);
                this.spaces?.add(_elem86);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.spaces != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.spaces?.length));
        for (var elem87 in this.spaces ?? []) {
          elem87.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListSpacesResp(");
