 ...
 *  @generated
 */
library nebula_meta.src.get_stats_req;
...
class GetStatsReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetStatsReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetStatsReq(");
