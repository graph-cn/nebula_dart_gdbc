 ...
 *  @generated
 */
library nebula.src.key_value;

import 'dart:typed_data' show Int8List;
import 'package:fbthrift/fbthrift.dart';
import '../nebula.dart';

class KeyValue implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("KeyValue");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("KeyValue(");
