 ...
 *  @generated
 */
library nebula_meta.src.drop_tag_index_req;
...
class DropTagIndexReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DropTagIndexReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DropTagIndexReq(");
