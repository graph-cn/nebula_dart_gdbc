 ...
 *  @generated
 */
library nebula_meta.src.drop_edge_req;
...
class DropEdgeReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DropEdgeReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DropEdgeReq(");
