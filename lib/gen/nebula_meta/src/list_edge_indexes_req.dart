 ...
 *  @generated
 */
library nebula_meta.src.list_edge_indexes_req;
...
class ListEdgeIndexesReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListEdgeIndexesReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListEdgeIndexesReq(");
