 ...
 *  @generated
 */
library nebula_meta.src.get_tag_resp;
...
class GetTagResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetTagResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetTagResp(");
