 ...
 *  @generated
 */
library nebula_meta.src.get_session_resp;
...
class GetSessionResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetSessionResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetSessionResp(");
