 ...
 *  @generated
 */
library nebula_storage.src.get_prop_response;
...
class GetPropResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetPropResponse");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetPropResponse(");
