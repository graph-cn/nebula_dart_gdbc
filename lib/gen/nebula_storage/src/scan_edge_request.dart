 ...
 *  @generated
 */
library nebula_storage.src.scan_edge_request;
...
class ScanEdgeRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ScanEdgeRequest");
  ...
  // return_columns
  List<EdgeProp>? get return_columns => this._return_columns;

  set return_columns(List<EdgeProp>? return_columns) {
    ...
    switch (fieldID) {
      ...
      case RETURN_COLUMNS:
        if (value == null) {
          ...
          this.return_columns = value as List<EdgeProp>;
        }
        break;
  ...
  write(TProtocol oprot) {
    ...
    if (this.parts != null) {
      oprot.writeFieldBegin(_PARTS_FIELD_DESC);
      {
        ...
        for (var elem238 in this.parts?.keys ?? <int>[]) {
          oprot.writeI32(elem238);
          this.parts?[elem238]?.write(oprot);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.return_columns != null) {
      oprot.writeFieldBegin(_RETURN_COLUMNS_FIELD_DESC);
      {
        ...
        for (var elem239 in this.return_columns ?? <EdgeProp>[]) {
          elem239.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ScanEdgeRequest(");
