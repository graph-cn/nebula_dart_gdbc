 ...
 *  @generated
 */
library nebula_meta.src.get_tag_index_resp;
...
class GetTagIndexResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetTagIndexResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetTagIndexResp(");
