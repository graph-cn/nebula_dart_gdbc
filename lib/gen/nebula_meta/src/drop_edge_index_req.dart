 ...
 *  @generated
 */
library nebula_meta.src.drop_edge_index_req;
...
class DropEdgeIndexReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DropEdgeIndexReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DropEdgeIndexReq(");
