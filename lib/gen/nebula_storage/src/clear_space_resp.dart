 ...
 *  @generated
 */
library nebula_storage.src.clear_space_resp;
...
class ClearSpaceResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ClearSpaceResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ClearSpaceResp(");
