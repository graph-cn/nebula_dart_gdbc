 ...
 *  @generated
 */
library nebula_storage.src.delete_edges_request;
...
class DeleteEdgesRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DeleteEdgesRequest");
              ...
              for (int _i153 = 0; _i153 < _map152.length; ++_i153) {
                ...
                _key154 = iprot.readI32();
                {
                  ...
                  for (int _i157 = 0; _i157 < _list156.length; ++_i157) {
                    EdgeKey _elem158;
                    _elem158 = new EdgeKey();
                    _elem158.read(iprot);
                    _val155.add(_elem158);
                  }
                  iprot.readListEnd();
                }
                this.parts?[_key154] = _val155;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parts != null) {
      oprot.writeFieldBegin(_PARTS_FIELD_DESC);
      {
        ...
        for (var elem160 in this.parts?.keys ?? <int>[]) {
          oprot.writeI32(elem160);
          {
            oprot.writeListBegin(
                new TList(TType.STRUCT, this.parts?[elem160]?.length));
            for (var elem161 in this.parts?[elem160] ?? <EdgeKey>[]) {
              elem161.write(oprot);
            }
            oprot.writeListEnd();
          }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DeleteEdgesRequest(");
