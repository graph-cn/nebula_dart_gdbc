 ...
 *  @generated
 */
library nebula_meta.src.get_space_resp;
...
class GetSpaceResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetSpaceResp");
  ...
  // item
  SpaceItem? get item => this._item;

  set item(SpaceItem? item) {
    this._item = item;
  }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetSpaceResp(");
