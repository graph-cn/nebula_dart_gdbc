 ...
 *  @generated
 */
library nebula_storage.src.stop_task_resp;
...
class StopTaskResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("StopTaskResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("StopTaskResp(");
