 ...
 *  @generated
 */
library nebula_meta.src.list_configs_resp;
...
class ListConfigsResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListConfigsResp");
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i213 = 0; _i213 < _list212.length; ++_i213) {
                ConfigItem _elem214;
                _elem214 = new ConfigItem();
                _elem214.read(iprot);
                this.items?.add(_elem214);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListConfigsResp(");
