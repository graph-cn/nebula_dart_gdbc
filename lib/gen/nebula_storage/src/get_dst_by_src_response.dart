 ...
 *  @generated
 */
library nebula_storage.src.get_dst_by_src_response;
...
class GetDstBySrcResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetDstBySrcResponse");
  static final TField _RESULT_FIELD_DESC =
      new TField("result", TType.STRUCT, 1);
  static final TField _DSTS_FIELD_DESC = new TField("dsts", TType.STRUCT, 2);

  ResponseCommon? _result;
  static const int RESULT = 1;
  t_nebula.DataSet? _dsts;
  static const int DSTS = 2;
    ...
    switch (fieldID) {
      ...
      case DSTS:
        if (value == null) {
          ...
          this.dsts = value as t_nebula.DataSet;
        }
        break;
  ...
  read(TProtocol iprot) {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case DSTS:
          if (field.type == TType.STRUCT) {
            this.dsts = new t_nebula.DataSet();
  ...
  write(TProtocol oprot) {
    ...
    if (isSetDsts()) {
      if (this.dsts != null) {
        oprot.writeFieldBegin(_DSTS_FIELD_DESC);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetDstBySrcResponse(");
