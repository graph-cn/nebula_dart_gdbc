 ...
 *  @generated
 */
library nebula_meta.src.get_zone_req;
...
class GetZoneReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetZoneReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetZoneReq(");
