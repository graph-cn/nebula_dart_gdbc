 ...
 *  @generated
 */
library nebula_meta.src.job_desc;
...
class JobDesc implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("JobDesc");
  ...
  // paras
  List<String>? get paras => this._paras;

  set paras(List<String>? paras) {
    this._paras = paras;
  }
    ...
    switch (fieldID) {
      ...
      case PARAS:
        if (value == null) {
          ...
          this.paras = value as List<String>;
        }
        break;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("JobDesc(");
