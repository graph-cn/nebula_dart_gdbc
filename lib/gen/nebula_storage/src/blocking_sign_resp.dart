 ...
 *  @generated
 */
library nebula_storage.src.blocking_sign_resp;
...
class BlockingSignResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("BlockingSignResp");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("BlockingSignResp(");
