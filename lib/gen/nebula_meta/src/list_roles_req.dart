 ...
 *  @generated
 */
library nebula_meta.src.list_roles_req;
...
class ListRolesReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListRolesReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListRolesReq(");
