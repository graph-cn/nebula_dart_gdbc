 ...
 *  @generated
 */
library nebula_meta.src.list_tags_req;
...
class ListTagsReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListTagsReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListTagsReq(");
