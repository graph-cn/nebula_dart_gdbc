 ...
 *  @generated
 */
library nebula_meta.src.get_config_resp;
...
class GetConfigResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetConfigResp");
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i209 = 0; _i209 < _list208.length; ++_i209) {
                ConfigItem _elem210;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetConfigResp(");
