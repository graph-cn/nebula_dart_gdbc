 ...
 *  @generated
 */
library nebula_meta.src.drop_space_req;
...
class DropSpaceReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DropSpaceReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DropSpaceReq(");
