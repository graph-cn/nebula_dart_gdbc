 ...
 *  @generated
 */
library nebula_meta.src.create_backup_resp;
...
class CreateBackupResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("CreateBackupResp");
  ...
  static final TField _META_FIELD_DESC = new TField("meta", TType.STRUCT, 3);
  ...
  // meta
  BackupMeta? get meta => this._meta;

  set meta(BackupMeta? meta) {
    this._meta = meta;
  }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("CreateBackupResp(");
