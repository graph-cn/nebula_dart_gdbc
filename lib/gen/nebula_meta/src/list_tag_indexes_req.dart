 ...
 *  @generated
 */
library nebula_meta.src.list_tag_indexes_req;
...
class ListTagIndexesReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ListTagIndexesReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ListTagIndexesReq(");
