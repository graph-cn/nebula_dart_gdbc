 ...
 *  @generated
 */
library nebula_storage.src.remove_part_req;
...
class RemovePartReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("RemovePartReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("RemovePartReq(");
