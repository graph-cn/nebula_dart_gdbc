 ...
 *  @generated
 */
library nebula_storage.src.partition_result;
...
class PartitionResult implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("PartitionResult");
  ...
  read(TProtocol iprot) {
    ...
    if (!__isset_code) {
      throw new TProtocolError(TProtocolErrorType.UNKNOWN,
          "Required field 'code' was not found in serialized data! Struct: ${toString()}");
    }

    if (!__isset_part_id) {
      throw new TProtocolError(TProtocolErrorType.UNKNOWN,
          "Required field 'part_id' was not found in serialized data! Struct: ${toString()}");
    }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("PartitionResult(");
