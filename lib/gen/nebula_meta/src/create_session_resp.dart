 ...
 *  @generated
 */
library nebula_meta.src.create_session_resp;
...
class CreateSessionResp implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("CreateSessionResp");
  ...
  static final TField _SESSION_FIELD_DESC =
      new TField("session", TType.STRUCT, 3);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("CreateSessionResp(");
