 ...
 *  @generated
 */
library nebula_meta.src.get_tag_index_req;
...
class GetTagIndexReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetTagIndexReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetTagIndexReq(");
