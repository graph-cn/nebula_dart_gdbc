 ...
 *  @generated
 */
library nebula_storage.src.drop_cp_request;
...
class DropCPRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("DropCPRequest");
  ...
  write(TProtocol oprot) {
    ...
    if (this.space_ids != null) {
      oprot.writeFieldBegin(_SPACE_IDS_FIELD_DESC);
      {
        ...
        for (var elem305 in this.space_ids ?? []) {
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("DropCPRequest(");
