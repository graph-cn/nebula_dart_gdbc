 ...
 *  @generated
 */
library nebula_meta.src.get_edge_req;
...
class GetEdgeReq implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetEdgeReq");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetEdgeReq(");
